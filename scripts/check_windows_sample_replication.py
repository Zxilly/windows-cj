...
MANUAL_BINDGEN_PLANS = {
    ...
    "windows/message_box": {
        "crates": ("windows",),
        "features": (),
        "filters": ("MessageBoxA", "MessageBoxW", "ShellMessageBoxW", "MB_OK", "MB_ICONERROR"),
    },
    "windows/com_uri": {
        "crates": ("windows",),
        "features": (),
        "filters": ("CreateUri", "IUri", "URI_CREATE_FLAGS"),
    },
    "windows/consent": {
        "crates": ("windows",),
        "features": (),
        "filters": (
            ...
            "Windows.Win32.System.WinRT.IUserConsentVerifierInterop.RequestVerificationForWindowAsync",
            "UserConsentVerificationResult",
            "Windows.Foundation.IAsyncOperation`1",
            "Windows.Foundation.AsyncOperationCompletedHandler`1",
            "Windows.Foundation.IAsyncOperation`1.Completed",
    ...
    "windows/data_protection": {
        ...
        "filters": (
            ...
            "IBuffer",
            "Windows.Storage.Streams.IBuffer.Length",
            "IBufferByteAccess",
            "Windows.Win32.System.WinRT.IBufferByteAccess.Buffer",
            "Windows.Foundation.IAsyncOperation`1",
            "Windows.Foundation.AsyncOperationCompletedHandler`1",
            "Windows.Foundation.IAsyncOperation`1.Completed",
            "Windows.Foundation.IAsyncOperation`1.GetResults",
    ...
    "windows/memory_buffer": {
        ...
        "filters": (
            ...
            "Windows.Win32.System.WinRT.IMemoryBufferByteAccess.GetBuffer",
        ),
    },
    "windows/ocr": {
        "crates": ("windows",),
        ...
        "filters": (
            ...
            "IOcrEngineStatics",
            "IOcrResult",
            "Windows.Media.Ocr.IOcrEngine.RecognizeAsync",
            "Windows.Media.Ocr.IOcrEngineStatics.TryCreateFromUserProfileLanguages",
            "Windows.Media.Ocr.IOcrResult.Text",
            "Windows.Foundation.IAsyncOperation`1",
            "Windows.Foundation.AsyncOperationCompletedHandler`1",
            "Windows.Foundation.IAsyncOperation`1.Completed",
            "Windows.Foundation.IAsyncOperation`1.GetResults",
    ...
    "windows-sys/message_box": {
        "crates": ("windows-sys",),
        "features": (),
        "filters": ("MessageBoxA", "ShellMessageBoxW", "MB_OK", "MB_ICONERROR"),
    },
    "windows-sys/create_window": {
        "crates": ("windows-sys",),
        "features": (),
        "filters": (
            "CreateWindowExA",
...
def load_sample_plan(cargo_toml: Path, samples_root: Path) -> SamplePlan:
    ...
    manual_features = manual.get("features")
    plan_features = unique_sorted(features)
    if isinstance(manual_features, tuple):
        plan_features = unique_sorted(manual_features)
    ...
    return SamplePlan(
        ...
        namespaces=unique_sorted([namespace for feature in plan_features if (namespace := feature_to_namespace(feature)) is not None]),
